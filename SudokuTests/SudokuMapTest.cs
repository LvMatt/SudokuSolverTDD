...
namespace SudokuTests
{
    ...
    public class SudokuMapTest
    {
        ...
        public void GenerateMap()
        {
            ...
            string answer = "y";
            var testGenerateBoard = solver.generateBoard(testBoard, maxNumber, answer);
        ...
        public void CheckTheMaxDepthOfBoard()
        {
            int maxNumber = 14;
            string answer = "y";
            solver.generateBoard(testBoard, maxNumber, answer);
        ...
        public void CheckBoardMapIfColumnsAreLessThan9()
        {
            int maxNumber = testBoard.GetLength(0);
            string answer = "y";
            solver.generateBoard(testBoard3, maxNumber, answer);
        }
        ...
        public void CheckBoardMapIfRowssAreLessThan9()
        {
            int maxNumber = testBoard.GetLength(0);
            string answer = "y";
            solver.generateBoard(testBoard2, maxNumber, answer);
        }
    }
}
